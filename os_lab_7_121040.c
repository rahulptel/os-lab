/*This code implements the banker's algorithm to implement the deadlock detection*/
//Include the header for necessary header
#include<stdio.h>
...
/******Enter maximum matrix******/
	...
	for(i=0;i<P;i++){
		mark[i]=0;
		for(j=0;j<R;j++){
		printf("\nEnter %d element of %d row:",j+1,i+1);
		scanf("%d",&max[i][j]);
		}
	}
...
/******Enter available vector******/
	...
	for(j=0;j<R;j++){
		printf("\nEnter %d element of available vector:",j+1);
		scanf("%d",&available[j]);
	}
